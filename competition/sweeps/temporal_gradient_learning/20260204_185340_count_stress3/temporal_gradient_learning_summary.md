...
|-------|------------|--------------|------|-------|---------|--------|--------|--------|--------|-------------|
| initial | 672.098085 | 672.096863 | 1000.000 | 8000000.000 | 1.800000 | 11.175 | 13.756 | 14.715 | 15.227 | 134.271 |
| final | 672.096705 | 672.096757 | 1002.300 | 7999987.870 | 1.800000 | 11.168 | 13.754 | 14.714 | 15.226 | 134.267 |

Initial vs final term contribution (% of total loss):

| State | timing % | count % | order % | energy % |
|-------|----------|---------|---------|----------|
| initial | 0.010 | 99.985 | 0.000 | 0.004 |
| final | 0.010 | 99.986 | 0.000 | 0.004 |
...
|------|------------|--------------|--------|-----------|-----------|------------|---------|---------|-----|--------------|----------------|----------------|
| 0 | 672.098085 | 672.096863 | 0.068085 | 672.000000 | 0.000000 | 0.030000 | 0.010 | 0.004 | 0.030 | -0.290866 | 0.002022 | -1.212967 |

Artifacts:
- Eval CSV: `/home/v71349/analog-gradients/competition/sweeps/temporal_gradient_learning/20260204_185340_count_stress3/temporal_gradient_learning.csv`
- Trace CSV: `/home/v71349/analog-gradients/competition/sweeps/temporal_gradient_learning/20260204_185340_count_stress3/temporal_gradient_trace.csv`
- Loss plot: `/home/v71349/analog-gradients/competition/sweeps/temporal_gradient_learning/20260204_185340_count_stress3/temporal_gradient_learning_loss.svg`
