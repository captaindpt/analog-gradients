...
\midrule
Synapse & \(V_{\text{post,max}}\) & \SI{1.418}{V} \\
Synapse & Output pulse count & 6 \\
LIF neuron & Total spikes detected & 10 \\
LIF neuron & \(V_{\text{mem,max}}\) & \SI{1.651}{V} \\
Neuron tile & Spike-node pulses & 11 \\
Neuro Tile4 & First spike times & 47.5, 49.5, 51.5, 53.5 ns \\
Neuro Tile4 Coupled & Membrane maxima & 0.642, 0.993, 1.216, 0.756 V \\
Neuro Tile4 Coupled & Spike counts & 15, 15, 15, 15 \\
...
Temporal sensitivity \(dt_{\text{spike0}}/dr_{fb}\) & -0.663 ns/kOhm & \texttt{competition/analysis/temporal\_sensitivity\_summary.md} \\
